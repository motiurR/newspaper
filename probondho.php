                ...
                <div class="caption probondho_details">
                    ...
                    <div class="sahitto_part_2">
                        <div class="row">
                            ...
                            <?php
                               $news = new NewsAddN();
                                $getpeobondho = $news->getallprobondhoNews2ndpart();
                                if ($getpeobondho) {
                                  while ($result = $getpeobondho->fetch_assoc()) {
                            ?>
                                <div class="col-lg-4">
                                    <div class="thumbnail thumbnail_contents">
                                        <img src="global-panel/<?php echo $result['image']; ?>" alt="Sahitto Picture" class="img-responsive">
                                        <div class="caption thumbnail_captions">
                                            <h3 class="text-center">প্রবন্ধের নাম: <?php echo $result['sahittowriter'];?></h3>
