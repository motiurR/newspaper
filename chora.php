...
<div class="chora_page">
            <div class="container">
                <div class="row">
                    <div class="cover_pic">
                        <img src="images/chora.jpg" alt="Cover Image" class="img-responsive"/>
                        <div class="cover_title">
                            <h2>সাহিত্য</h2>
                        </div>
                    </div>
                    <div class="chora_body">
                        <div class="chora_body_content">
                            <h2>ঘাসফড়িং</h2>
                            <div class="chora_body_details">
                                <div class="row">

                       <?php
                           $news = new NewsAddN();
                            $getChora = $news->getallChoraNews();
                            if ($getChora) {
                              while ($result = $getChora->fetch_assoc()) {
                        ?>
                                    <div class="col-lg-4">
                    ...
                    <div class="chora_body_part_2">
                        <div class="row">
                            <div class="chora_body_part_content">

                        <?php
                           $news = new NewsAddN();
                            $getChora = $news->getallChoraNewsfor2ndpart();
                            if ($getChora) {
                              while ($result = $getChora->fetch_assoc()) {
                        ?>
